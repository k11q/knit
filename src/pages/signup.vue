    ...
    >
      <div class="flex flex-col w-full gap-3">
        ...
        <div class="flex flex-col gap-2">
          <button
            class="px-4 py-[10px] bg-[#414045] rounded-md font-medium text-[13px]"
            @click="login('google')"
          >
            Sign up with Google
          </button>
        ...
        <div class="flex flex-col gap-5 items-start">
          <div class="flex flex-col gap-3 items-start w-full">
            ...
            <input
              ...
              required
              id="firstName"
              class="bg-[#1F1F23] border border-[#444444] pl-4 py-[10px] rounded-md w-full autofill:bg-[#1F1F23] focus:outline-[#47CE90]"
              v-model="firstName"
            />
          </div>
          <div class="flex flex-col gap-3 items-start w-full">
          ...
          <div class="flex flex-row place-content-between items-center w-full">
            <div class="flex flex-row gap-3 items-center">
              <input
                ...
                name="vehicle1"
                value="Bike"
                class="appearance-none rounded-md w-4 h-4 accent-[#47CE90] bg-[#1F1F23] border border-[#444444] autofill:bg-[#1F1F23]"
              />
