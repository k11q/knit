<template>
  <aside
    class="border-r w-60 flex flex-col flex-none h-screen overflow-x-hidden pb-16 z-10 text-xs border-[#3A3A3A] bg-[#262626]"
  >
    <div
      class="border-b px-[18px] h-[52px] flex flex-row gap-4 items-center border-[#3A3A3A]"
    >
      <div
    ...
    <div class="flex flex-col w-full h-fit">
      ...
      >
        <div class="flex flex-col">
          <div
            class="flex flex-row gap-4 items-center hover:bg-[#262626] py-[10px] px-[18px]"
          >
            <div
              class="flex flex-col items-center justify-center w-3 flex-none aspect-square opacity-80"
            >
