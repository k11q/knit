<template>
  <aside
    class="border-l w-60 flex flex-col h-screen overflow-x-hidden pb-16 z-10 bg-[#18181A] border-[#040407]"
  >
    <div
      class="h-10 flex-none flex flex-row items-center px-2 sticky top-0 bg-[#18181A]"
    >
      <div
